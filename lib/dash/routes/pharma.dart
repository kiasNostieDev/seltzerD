...
class Pharma extends StatefulWidget {
  const Pharma({Key? key}) : super(key: key);
                  ...
                  rows: <DataRow>[
                    DataRow(
                      cells: <DataCell>[
                        ...
                        DataCell(ElevatedButton(onPressed: () {}, child: const Text("SHOW"), style: ElevatedButton.styleFrom(primary: const Color(
                            0xff32DBA2)),))
                      ],
                    ),
                    DataRow(
                    ...
                    DataRow(
                      cells: <DataCell>[
                        ...
                        DataCell(Text('Yes', style: GoogleFonts.raleway(fontWeight: FontWeight.w500, fontSize: 15.0),)),
                        DataCell(Text('13/10/19', style: GoogleFonts.raleway(fontWeight: FontWeight.w500, fontSize: 15.0),)),
                        DataCell(ElevatedButton(onPressed: () {}, child: const Text("SHOW"), style: ElevatedButton.styleFrom(primary: const Color(0xff32DBA2)),))
                      ],
                    ),
                    DataRow(
                      cells: <DataCell>[
